...
public class UserCouponController {
    ...
    public  Result<List<UserCoupon>> getCouponsByUserIdAndStatus(
        ...
        if (status < 0 || status > 2) {
            ...
            return  Result.failed(ResultCode.VALIDATE_FAILED, "优惠券状态无效");
        }
    ...
    public  Result<UserCoupon> getUserCouponById(
        ...
        if (userCoupon != null) {
            ...
            return  Result.failed(ResultCode.VALIDATE_FAILED, "用户优惠券不存在");
        }
    }
    ...
    public  Result<Boolean> addUserCoupon(@Valid @RequestBody UserCoupon userCoupon) {
        ...
        if (result) {
            ...
            return  Result.failed(ResultCode.FAILED, "优惠券领取失败");
        }
    }
    ...
    public  Result<Boolean> receiveCoupon(
        ...
        if (userId == null || couponId == null) {
            ...
            return  Result.failed(ResultCode.VALIDATE_FAILED, "用户ID和优惠券ID不能为空");
        }
    ...
    public  Result<Boolean> updateUserCoupon(@Valid @RequestBody UserCoupon userCoupon) {
        ...
        if (result) {
            ...
            return  Result.failed(ResultCode.FAILED, "优惠券更新失败");
        }
    }
    ...
    public  Result<Boolean> useCoupon(
        ...
        if (userCoupon == null) {
            ...
            return  Result.failed(ResultCode.VALIDATE_FAILED, "优惠券不存在");
        }

        if (userCoupon.getStatus() != 0) {
            log.warn("使用优惠券失败: id={}, 优惠券状态无效, status={}", id, userCoupon.getStatus());
            return  Result.failed(ResultCode.VALIDATE_FAILED, "优惠券已使用或已过期");
        }
        ...
        if (result) {
            ...
            return  Result.failed(ResultCode.FAILED, "优惠券使用失败");
        }
    }
    ...
    public  Result<Boolean> deleteUserCoupon(
        ...
        if (result) {
            ...
            return  Result.failed(ResultCode.FAILED, "优惠券删除失败");
        }
    }
    ...
    public  Result<Boolean> batchDeleteUserCoupons(@RequestBody List<Long> ids) {
        ...
        if (result) {
            ...
            return  Result.failed(ResultCode.FAILED, "批量删除失败");
        }
    }
    ...
    public  Result<Integer> countUserAvailableCoupons(@PathVariable Long userId) {
        ...
        return  Result.success(availableCoupons.size());
    }
