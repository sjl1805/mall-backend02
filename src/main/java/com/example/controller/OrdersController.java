...
public class OrdersController {
    ...
    public  Result<Orders> getOrderById(
        ...
        if (order != null) {
            ...
            return  Result.failed(ResultCode.NOT_FOUND, "订单不存在");
        }
    }
    ...
    public  Result<Boolean> addOrder(@Valid @RequestBody Orders order) {
        ...
        if (!isCurrentUserOrAdmin(order.getUserId())) {
            ...
            return  Result.failed(ResultCode.FORBIDDEN, "无权为其他用户创建订单");
        }
    ...
    public  Result<Boolean> updateOrder(@Valid @RequestBody Orders order) {
        ...
        if (order.getId() == null) {
            ...
            return  Result.failed(ResultCode.VALIDATE_FAILED, "订单ID不能为空");
        }
    ...
    public  Result<List<Map<String, Object>>> getOrderStatistics(
        ...
        if (userId != null && !isCurrentUserOrAdmin(userId)) {
            ...
            return  Result.failed(ResultCode.FORBIDDEN, "无权查看其他用户的订单统计");
        }
    ...
    public  Result<Boolean> updatePaymentInfo(
        ...
        if (orderNo == null || orderNo.trim().isEmpty()) {
            ...
            return  Result.failed(ResultCode.VALIDATE_FAILED, "订单号不能为空");
        }
        
        if (paymentMethod == null) {
            log.warn("更新订单支付信息失败: 支付方式为空");
            return  Result.failed(ResultCode.VALIDATE_FAILED, "支付方式不能为空");
        }
    ...
    public  Result<Boolean> updateShippingInfo(
        ...
        if (logisticsCompany == null || logisticsCompany.trim().isEmpty()) {
            ...
            return  Result.failed(ResultCode.VALIDATE_FAILED, "物流公司不能为空");
        }
        
        if (trackingNumber == null || trackingNumber.trim().isEmpty()) {
            log.warn("更新订单物流信息失败: 运单号为空");
            return  Result.failed(ResultCode.VALIDATE_FAILED, "运单号不能为空");
        }
    ...
    public  Result<Map<String, Object>> getOrderDetail(
        ...
        if (orderDetail != null && !orderDetail.isEmpty()) {
            ...
            return  Result.failed(ResultCode.NOT_FOUND, "订单不存在或无详情");
        }
    }
    ...
    public  Result<Boolean> cancelOrder(
        ...
        if (order.getStatus() != 0) { // 假设0表示待支付状态
            ...
            return  Result.failed(ResultCode.FAILED, "只能取消待支付的订单");
        }
    ...
    public  Result<Boolean> confirmReceive(
        ...
        if (order.getStatus() != 2) { // 假设2表示已发货状态
            ...
            return  Result.failed(ResultCode.FAILED, "只能确认已发货的订单");
        }
    ...
    public  Result<Boolean> applyRefund(
        ...
        if (order.getStatus() <= 0 || order.getStatus() > 3) { // 假设只有状态1-3可以申请退款
            ...
            return  Result.failed(ResultCode.FAILED, "当前订单状态不允许申请退款");
        }
    ...
    public  Result<Integer> countTimeoutOrders(
        ...
        if (minutes <= 0) {
            ...
            return  Result.failed(ResultCode.VALIDATE_FAILED, "超时分钟数必须大于0");
        }
