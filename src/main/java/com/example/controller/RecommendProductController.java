...
public class RecommendProductController {
    ...
    @GetMapping("/{id}")
    public  Result<RecommendProduct> getRecommendProductById(
        ...
        if (product != null) {
            ...
            return  Result.failed(ResultCode.NOT_FOUND, "推荐商品不存在");
        }
    }
    ...
    public  Result<List<RecommendProduct>> getRecommendsByProductId(
    ...
    public  Result<List<RecommendProduct>> getRecommendsByType(
    ...
    public  Result<List<RecommendProduct>> generateSimilarProductRecommends(
            @Parameter(description = "商品ID", required = true) @PathVariable Long productId,
            @Parameter(description = "推荐数量") @RequestParam(defaultValue = "10") Integer limit) {
    ...
    public  Result<List<RecommendProduct>> generateAlsoBoughtRecommends(
            @Parameter(description = "商品ID", required = true) @PathVariable Long productId,
            @Parameter(description = "推荐数量") @RequestParam(defaultValue = "10") Integer limit) {
    ...
    public  Result<Boolean> batchUpdateStatus(
        ...
        if (ids == null || ids.isEmpty()) {
            ...
            return  Result.failed(ResultCode.VALIDATE_FAILED, "ID列表不能为空");
        }
